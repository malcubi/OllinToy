!$Header: /usr/local/ollincvs/Codes/OllinToy/src/parse.f90,v 1.1 2005/02/18 19:15:00 malcubi Exp $

! ****************************
! ***   PARAMETER PARSER   ***
! ****************************

  subroutine parse(parfile)
...
!    ans save whatever is left in the string "word".
