...
#$Header: /usr/local/ollincvs/Codes/OllinToy/prl/assign.pl,v 1.2 2005/03/30 21:53:53 malcubi Exp $

print "CREATING FILE FOR PARAMETER ASSIGNMENT ...\n\n";

# Open outfile assign.f90

open(OUTFILE,">src/assign.f90") or die "Can't open assign.f90: $!";
...
open(INFILE,"src/param.f90") or die "Can't open param.f90: $!";
